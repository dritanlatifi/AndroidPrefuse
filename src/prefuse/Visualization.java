 ...
 * maintaining a list of {@link PDisplay} instances responsible for rendering
 ...
 * 
 * <p>Visualizations also maintain references to all the {@link PDisplay}
 * instances providing interactive views of the content of this
 * visualization. {@link PDisplay} instances registers themselves with
 * the visualization either in their constructor or through
 * the {@link PDisplay#setVisualization(Visualization)} method, so they
...
public class Visualization {
     ...
     */
    public PActivity cancel(String action) {
...
//          getDisplay(i).invalidate(); // TODO for Dritan: see if invalidate replaces the repaint method
     ...
     * {@link prefuse.PDisplay#setVisualization(Visualization)} method.
     * @param display the Display to add
     */
    void addDisplay(PDisplay display) {
     ...
     */
    boolean removeDisplay(PDisplay display) {
