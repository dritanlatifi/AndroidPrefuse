 ...
 */
public abstract class PActivity {
     ...
     * @see prefuse.activity.PActivity#Activity(long, long, long)     
     */
    public PActivity(long duration) {
     ...
     * @see prefuse.activity.PActivity#Activity(long, long, long)
     */
    public PActivity(long duration, long stepTime) {
     ...
     */
    public PActivity(long duration, long stepTime, long startTime) {
     ...
     */
    public void runAfter(PActivity before) {
     ...
     * @param before the Activity that must finish before this one starts
     */
    public void alwaysRunAfter(PActivity before) {
     ...
     *  an animation.
     * @see prefuse.activity.PActivity#getPacingFunction()
     */
