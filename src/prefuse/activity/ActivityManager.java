 ...
 * {@link prefuse.activity.PActivity#run()},
 * {@link prefuse.activity.PActivity#runAt(long)}, and 
 * {@link prefuse.activity.PActivity#runAfter(PActivity)}
...
public class ActivityManager extends Thread {
     ...
     */
    static void schedule(PActivity a) {
     ...
     * @param a the Activity to schedule
     */
    static void scheduleNow(PActivity a) {
     ...
     */
    static void scheduleAt(PActivity a, long startTime) {
     ...
     */
    static void scheduleAfter(PActivity before, PActivity after) {
     ...
     * @param after the Activity to run immediately after the first
     */
    static void alwaysScheduleAfter(PActivity before, PActivity after) {
     ...
     */
    static void cancelActivity(PActivity a){
     ...
     * @param a the Activity to schedule
     */
    private void _schedule(PActivity a, long startTime) {
        if ( a.isScheduled() ) {
     ...
     * @param after the Activity to run immediately after the first
     */
    private void _scheduleAfter(PActivity before, PActivity after) {
     ...
     * @param after the Activity to run immediately after the first
     */
    private void _alwaysScheduleAfter(PActivity before, PActivity after) {
     ...
     * @param a The Activity to cancel
     */
    private void _cancelActivity(PActivity a){
    	/*
     ...
     */
    private boolean _removeActivity(PActivity a) {
        boolean r;
        synchronized ( this ) {
    ...
    public class ScheduleAfterActivity extends ActivityAdapter {
        PActivity after;
        boolean remove;
        public ScheduleAfterActivity(PActivity after, boolean remove) {
            this.after = after;
            this.remove = remove;
        }
