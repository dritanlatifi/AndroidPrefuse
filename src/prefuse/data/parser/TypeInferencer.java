...
/**
 * Infers the data types for a table of data by testing each value of the data against a bank of parsers and eliminating candidate parsers that do not successfully parse the data. This class leverages
 * the mechanisms of {@link ParserFactory}, but while that class only supports one data field at a time, TypeInferencer maintains a collection of ParserFactory instances to infer type for multiple
 * data columns simultaneously.
 * 
...
public class TypeInferencer
{
	 ...
	 * 
	 * @param template
	 *            the template ParserFactory to use for included parsers and their precedence.
	 */
