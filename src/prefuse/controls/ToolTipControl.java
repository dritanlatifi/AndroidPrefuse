...
public class ToolTipControl extends ControlAdapter
{
	 ...
	 * 
	 * @param fields
	 *            the field names to use for the tooltip text. The values of each field will be concatenated to form the tooltip.
	 */
	...
	{
		showLabel(item, event);
	}
	@Override
	public void itemLongPress(VisualItem item, MotionEvent event)
	{
		showLabel(item, event);
	}
