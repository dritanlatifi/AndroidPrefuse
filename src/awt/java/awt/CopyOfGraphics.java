 ...
 * @since Android 1.0
 */
public abstract class CopyOfGraphics {
     ...
     */
    public CopyOfGraphics create(int x, int y, int width, int height) {
        CopyOfGraphics res = create();
        res.translate(x, y);
     ...
     * TODO for Dritan: this method exist already in android.graphics.Canvas. Check for conflicts. Fow now I will deactivate this method
     */
//    @Override
...
//    }
     ...
     * TODO for Dritan:  this function exists in android.graphics.Canvas but with other parameters. i.e. there is no confict, but must check if the functionality is the same
     * @param r
     ...
     */
    public abstract CopyOfGraphics create();
    ...
    /**
     * Gets the bounds of the current clipping area as a rectangle.
     * TODO for Dritan: this method exist already in android.graphics.Canvas. Conflict because of different return type 
