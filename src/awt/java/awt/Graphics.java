...
/**
 * The Graphics class allows applications to draw on a screen or other rendering
 * target. There are several properties which define rendering options: origin
 * point, clipping area, color, font. <br>
 * <br>
...
public interface Graphics {
	...
	/**
	 * Disposes of the Graphics. TODO for Dritan: this method exist already in
	 * android.graphics.Canvas. Check for conflicts. Fow now I will deactivate
	 * this method
	 */
	// @Override
	 ...
	 * to an existing rectangle. TODO for Dritan: this function exists in
	...
	/**
	 * Returns string which represents this Graphics object. TODO for Dritan:
	 * this method exist already in android.graphics.Canvas. Check for
	 * conflicts. Fow now I will deactivate this method
	 * 
	 ...
	 * clockwise rotation. TODO for Dritan: this function exists in
	 * android.graphics.Canvas but with other parameters. i.e. there is no
	 * confict, but must check if the functionality is the same
	 * 
	 * @param x
	 ...
	 * c) method. TODO for Dritan: this function exists in
	 * android.graphics.Canvas but with other parameters. i.e. there is no
	 * confict, but must check if the functionality is the same
	 * 
	 * @param x1
	 ...
	 * width, height, and top left corner. TODO for Dritan: this function exists
	 * in android.graphics.Canvas but with other parameters. i.e. there is no
	 * confict, but must check if the functionality is the same
	 * 
	 * @param x
	...
	/**
	 * Draws the outline of a rectangle with round corners. TODO for Dritan:
	 ...
	 * operation in this Graphics will be related to the new origin. TODO for
	 * Dritan: this function exists in android.graphics.Canvas but with other
	 * parameters. i.e. there is no confict, but must check if the functionality
	 * is the same
	 * 
	 * @param x
